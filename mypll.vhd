...
-- Module  Version: 5.7
--E:\lscc\diamond\3.11_x64\ispfpga\bin\nt64\scuba.exe -w -n mypll -lang vhdl -synth lse -arch mg5a00 -type pll -fin 10 -phase_cntl STATIC -fclkop 100 -fclkop_tol 0.0 -fb_mode CLOCKTREE -phaseadj 0.0 -duty 8 -fclkok 10 -fclkok_tol 0.0 -norst -noclkok2 

-- Mon Mar 13 07:43:14 2023
...
architecture Structure of mypll is
    ...
    attribute FIN of PLLInst_0 : label is "10.000000";
...
begin
    ...
    PLLInst_0: EPLLD1
        ...
        PHASEADJ=> "0.0", CLKOK_DIV=>  10, CLKOP_DIV=>  8, CLKFB_DIV=>  10, 
        CLKI_DIV=>  1)
        -- synopsys translate_on
...
-- synopsys translate_off
library xp2;
configuration Structure_CON of mypll is
    for Structure
